...
<title>Home</title>
 <link rel="stylesheet" type="text/css"
	href="${request.contextPath }/static/styles/logostyle.css"> 
<link
...
<body class="hero-bkg-animated" background="/static/images/bluepatt.jpg">
	...
	<a
		class="navbar-brand" href="/Vehicle_Reservation_System/homeAgain"><b>Vehicle Reservation System</b></a>
	<div class="collapse navbar-collapse" id="navbarColor01">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="/Vehicle_Reservation_System/homeAgain"><b>Home</b>
	...
	<div class="row" style="margin-top: -48px; width: 100%;">
		<form:form commandName="currentAdmin">
			<div class="card mb-3 col-sm-5"
				...
				<div class="card-footer" style="color: #ffffff"></div>
			</div>
		</form:form>
