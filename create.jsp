...
<body class="hero-bkg-animated" background="/static/images/bluepatt.jpg">
	...
	<div id="nav" class="navbar-header">
		<a class="navbar-brand" href="#"><img class="picture"
			src="${request.contextPath}/images/logo1.png" /></a>
	</div>
				...
				<div class=" col-md-7">
					<form:form id="createForm" method="post"
						...
						<div class="form-group">
							...
							<form:input type="text" id="datepicker-1" readonly="true" class="form-control"
						...
						<div class="form-group">
							...
							<form:input type="text" id="datepicker-2" readonly="true" class="form-control"
						...
						<div class="form-group">
							...
							<form:input type="text" id="datepicker-3" readonly="true" class="form-control"
